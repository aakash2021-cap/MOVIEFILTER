...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/mcmmovies"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/mcmmovies")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/mcmmovies'),
                InlineKeyboardButton('Channel ⭕️', https://t.me/mcmmovies')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/mcmmovies')
            ]
            ]
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/mcmmovies'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/mcmmovies')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/mcmmovies')
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/mcmmovies'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/mcmmovies')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/mcmmovies")
    ])
